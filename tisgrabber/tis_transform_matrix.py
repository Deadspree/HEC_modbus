...
def charuco_pose_estimation(image: np.ndarray,matrix_coefficients_path: (str), distortion_coefficients_path: (str),marker_length: float = 0.022, square_length: float  = 0.03, aruco_dict_type: int = cv2.aruco.DICT_6X6_100):
    """
    ...
    board = cv2.aruco.CharucoBoard((7, 5), squareLength, markerLength, dictionary)

...
def calibrate(
    ...
    path to attain the matrix coefficient and distortion coefficient
...
if __name__ == "__main__":
    ...
    ap.add_argument(
        ...
        "--width",
        type=int,
        help="Width of checkerboard (default=9)",
        default=9,
    )
    ap.add_argument(
        "-t",
        "--height",
        type=int,
        help="Height of checkerboard (default=6)",
        default=6,
    )
    ap.add_argument(
        "-s",
        ...
        type=float,
        default=0.02,
        help="Length of one edge (in metres)",
    )
    ap.add_argument(
        "-v",
        "--visualize",
    ...
    np.save(INPUT_DIR / "calibration_matrix_usb", mtx)
    np.save(INPUT_DIR / "distortion_coefficients_usb", dist)
...
if __name__ == '__main__':
    ...
    ap.add_argument("-s", "--square_size", type=float, default=0.02, help="Length of one edge (in metres)")
    ...
    np.save(INPUT_DIR/ "calibration_matrix", mtx)
    np.save(INPUT_DIR/ "distortion_coefficients", dist)